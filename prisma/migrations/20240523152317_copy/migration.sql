...
-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_planeId_fkey" FOREIGN KEY ("planeId") REFERENCES "planes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_bandara_keberangkatan_id_fkey" FOREIGN KEY ("bandara_keberangkatan_id") REFERENCES "airports"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_bandara_kedatangan_id_fkey" FOREIGN KEY ("bandara_kedatangan_id") REFERENCES "airports"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
